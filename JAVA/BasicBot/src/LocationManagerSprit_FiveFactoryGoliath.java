...
// 투혼 맵
public class LocationManagerSprit_FiveFactoryGoliath extends LocationManager {
	...
	if (allianceBaseLocation.equals(getBaseLocations(ONE_CLOCK))) {
	    // 1시
	    result.add(new TilePosition(92, 21));
	    ...
	    result.add(new TilePosition(111, 18));
	    result.add(new TilePosition(111, 21));
	} else if (allianceBaseLocation.equals(getBaseLocations(FIVE_CLOCK))) {
	    // 5시
	    result.add(new TilePosition(104, 89));
	    ...
	    // 7시
	    result.add(new TilePosition(37, 108));
	    ...
	    // 11시
	    result.add(new TilePosition(21, 39));
	    ...
	    result.add(new TilePosition(0, 26)); //애드온 건물
	    ...
	    result.add(new TilePosition(17, 17));
	}
	...
	if (allianceBaseLocation.equals(getBaseLocations(ONE_CLOCK))) {
	    // 1시
	    result.add(new TilePosition(93, 19));
	} else if (allianceBaseLocation.equals(getBaseLocations(FIVE_CLOCK))) {
	    // 5시
	    result.add(new TilePosition(105, 87));
	} else if (allianceBaseLocation.equals(getBaseLocations(SEVEN_CLOCK))) {
	    // 7시
	    result.add(new TilePosition(30, 109));
	} else if (allianceBaseLocation.equals(getBaseLocations(ELEVEN_CLOCK))) {
	    // 11시
	    result.add(new TilePosition(19, 34));
	}
	...
	if (allianceBaseLocation.equals(getBaseLocations(ONE_CLOCK))) {
	    // 1시
	    result.add(new TilePosition(86, 19));
	    ...
	    // 5시
	    result.add(new TilePosition(102, 87));
	    ...
	    result.add(new TilePosition(125, 96));
	    result.add(new TilePosition(125, 98));

	} else if (allianceBaseLocation.equals(getBaseLocations(SEVEN_CLOCK))) {
	    // 7시
	    result.add(new TilePosition(32, 107));
	    ...
	    result.add(new TilePosition(0, 99));
	    result.add(new TilePosition(3, 99));
	    ...
	    // 11시
	    result.add(new TilePosition(22, 34));
	    result.add(new TilePosition(5, 29));
	    result.add(new TilePosition(0, 29));
	...
	if (allianceBaseLocation.equals(getBaseLocations(ONE_CLOCK))) {
	    ...
	    // 7시
	    result.add(new TilePosition(46, 112));
	...
	if (allianceBaseLocation.equals(getBaseLocations(ONE_CLOCK))) {
	    // 1시
	    result = new TilePosition(95, 26);
	} else if (allianceBaseLocation.equals(getBaseLocations(FIVE_CLOCK))) {
	    // 5시
	    result = new TilePosition(98, 92);
	} else if (allianceBaseLocation.equals(getBaseLocations(SEVEN_CLOCK))) {
	    // 7시
	    result = new TilePosition(35, 103);
	} else if (allianceBaseLocation.equals(getBaseLocations(ELEVEN_CLOCK))) {
	    // 11시
	    result = new TilePosition(29, 36);
	}
	...
	if (allianceBaseLocation.equals(getBaseLocations(ONE_CLOCK))) {
	    // 1시
	    result = new TilePosition(92, 18);
	} else if (allianceBaseLocation.equals(getBaseLocations(FIVE_CLOCK))) {
	    // 5시
	    result = new TilePosition(109, 94);
	} else if (allianceBaseLocation.equals(getBaseLocations(SEVEN_CLOCK))) {
	    // 7시
	    result = new TilePosition(39, 111);
	} else if (allianceBaseLocation.equals(getBaseLocations(ELEVEN_CLOCK))) {
	    // 11시
	    result = new TilePosition(20, 40);
	}
	...
	if (allianceBaseLocation.equals(getBaseLocations(ONE_CLOCK))) {
	    result.add(new TilePosition(88, 21));
	} else if (allianceBaseLocation.equals(getBaseLocations(FIVE_CLOCK))) {
	    result.add(new TilePosition(104, 92));
	} else if (allianceBaseLocation.equals(getBaseLocations(SEVEN_CLOCK))) {
	    result.add(new TilePosition(33, 109));
	} else if (allianceBaseLocation.equals(getBaseLocations(ELEVEN_CLOCK))) {
	    result.add(new TilePosition(19, 36));
	}
	...
	if (allianceBaseLocation.equals(getBaseLocations(ONE_CLOCK))) {
	    // 1시
	    result.add(new TilePosition(106, 17));
	} else if (allianceBaseLocation.equals(getBaseLocations(FIVE_CLOCK))) {
	    // 5시
	    result.add(new TilePosition(106, 101));
	} else if (allianceBaseLocation.equals(getBaseLocations(SEVEN_CLOCK))) {
	    // 7시
	    result.add(new TilePosition(18, 107));
	} else if (allianceBaseLocation.equals(getBaseLocations(ELEVEN_CLOCK))) {
	    // 11시
	    result.add(new TilePosition(15, 24));
	}
	return result;
    }
	...
	if (enemyStartLocation != null) {
		...
		result.add(new TilePosition(126, 0));
		result.add(new TilePosition(125, 24));
